...
COPY 10_input.conf 20_filter.conf 90_output.conf /etc/logstash/conf.d/

# Script that creates static mapping in Elastic prior to log ingestion
COPY createmapping.sh /etc/init.d/createmapping.sh 
...
# Allow supervisor to manage the processes
